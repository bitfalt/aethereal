...
contract Aether is ERC721, ERC721Enumerable, ERC721URIStorage {
    ...
    // @notice Event emitted when the leaderboard is updated
    event LeaderboardUpdated(address indexed newLeaderboardAddress, uint256 newScore);
